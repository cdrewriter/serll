...
import PriceCategories from '../../components/sidebars/PriceCategoriesMains';
    ...
    return (
      <>
        <Container maxWidth="md">
          <Breadcrumbs
            pageTitle="Сервис и Техническое обслуживание"
            pagePath="/services"
            parts={[
              {
                title: 'Главная',
        ...
        <Container fixed>
          <Box m={8} style={{ display: 'flex', flexWrap: 'wrap' }}>
            ...
            />
            <BlockHead
              heading="Сервис и Техническое обслуживание"
              subheading="Техническое обслуживание автомобилей Урал, Камаз и спецтехники"
...
ServicesCategoryList.propTypes = {};
