...
<Container maxWidth="lg">
                        <Box display="flex"  my={8}  justifyContent="spaceBetween">
                           
                                <BlockHead 
                                heading="Запасные части" 
                                subheading="к автомобилю Урал, Камаз" 
                            
                                justifyContent="center"> 
                                    <SparePartsIcon className={classes.iconlogo}  style={{ fontSize: '4rem', marginRight: '2rem',  color: grey[300]}} viewBox="0 0 80 91.429"/>
